...
export const fetchTeam = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get('https://ssc-final-backend.onrender.com/api/postHolders/spc');
...
export const fetchEvents = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get('https://ssc-final-backend.onrender.com/api/events/spc');
